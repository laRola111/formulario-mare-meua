...
// Componente de icono SVG para Instagram
...
const SUBMIT_URL = 'https://script.google.com/macros/s/AKfycbwQDv6r1ihDxryKxpLJq5m4GdXXY-xoftvrPV4Z10Jhm8twWbBz8icHRtvcasvzrpSI/exec';
    ...
    <div className="min-h-screen bg-transparent flex flex-col justify-between py-3 sm:py-12 px-3 sm:px-6 lg:px-8">
            ...
            {currentStep === 1 && (
              ...
              >
                ...
                {company.logoUrl ? (
                  ...
                  <div className="mx-auto w-16 h-16 bg-indigo-50 rounded-2xl flex items-center justify-center text-indigo-600 mb-2">
                    <Globe className="h-8 w-8 text-indigo-500" />
                  </div>
                )}
                
                <h1 className="text-3xl font-extrabold sm:text-4xl tracking-tight gradient-text">
                  {t.welcomeTitle}
                </h1>
                ...
                <div className="pt-6">
                  <button
                    type="button"
                    onClick={nextStep}
                    className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 rounded-xl text-white font-semibold gradient-btn gap-2 text-base cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 animate-pulse hover:animate-none"
                  >
                    {t.startBtn}
              ...
              >
                ...
                <div className="pt-6">
                  <button
                    ...
                    className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-3.5 rounded-xl text-white font-semibold gradient-btn transition-colors shadow-lg gap-2 cursor-pointer"
                  >
                    {t.finishBtn}
                  </button>
                </div>
      ...
      {currentStep > 1 && currentStep < 19 && (
        <div className="max-w-2xl mx-auto w-full flex items-center justify-between mt-4 sm:mt-8 px-2">
          <button
            type="button"
            onClick={prevStep}
            className="inline-flex items-center justify-center px-5 py-3 rounded-xl border border-slate-200 bg-white/70 backdrop-blur text-slate-600 font-semibold hover:bg-slate-50 transition-colors cursor-pointer text-sm gap-2"
          >
          ...
          {currentStep === 18 ? (
            <button
              ...
              className="inline-flex items-center justify-center px-6 py-3 rounded-xl text-white font-semibold gradient-btn transition-all shadow-lg cursor-pointer text-sm gap-2 disabled:opacity-50"
            >
            ...
            <button
              type="button"
              onClick={nextStep}
              className="inline-flex items-center justify-center px-6 py-3 rounded-xl text-white font-semibold gradient-btn transition-all shadow-lg cursor-pointer text-sm gap-2"
            >
              {t.nextBtn}
      ...
      {currentStep > 1 && currentStep < 19 && (
        <div className="max-w-2xl mx-auto w-full mt-3 sm:mt-4 px-2">
          <div className="w-full bg-slate-200/50 backdrop-blur h-1.5 rounded-full overflow-hidden">
            <div 
      ...
      <footer className="max-w-2xl mx-auto w-full text-center mt-6 sm:mt-12 text-xs text-slate-400 space-y-2">
        <p className="font-semibold text-slate-500">{company.name} © 2026. Todos los derechos reservados.</p>
        <div className="flex flex-wrap justify-center gap-x-2 gap-y-1">
          {company.address && <span>{company.address}</span>}
          {company.address && (company.email || company.phone) && <span>•</span>}
        ...
        {company.instagram && (
          <div className="flex justify-center pt-1">
            <a 
              ...
              className="inline-flex items-center gap-1 text-slate-400 transition-colors"
              onMouseEnter={(e) => e.currentTarget.style.color = company.primaryColor}
              onMouseLeave={(e) => e.currentTarget.style.color = ''}
            >
              <InstagramIcon className="h-4 w-4" />
              <span>@ruedalarola</span>
            </a>
          </div>
        )}
      </footer>
